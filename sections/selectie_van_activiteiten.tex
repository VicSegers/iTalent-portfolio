...
\input{sections/selectie_activiteiten/care-athon}

\subsection{Studiereis: Berlijn (Technische Universit\"at Berlin)}
\input{sections/selectie_activiteiten/studiereis}

\subsection{AariXa - Docker for Dev and Ops}
\input{sections/selectie_activiteiten/docker}

\subsection{\LaTeX - Softwaresysteem voor het zetten van documenten}
\input{sections/selectie_activiteiten/latex}
